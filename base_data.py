...
rsa_encode = 'http://118.190.17.80:8081/api/rsa/encode/%s'

save_order = 'http://118.190.17.80:8000/api/mobilepay/order'
set_order_status = 'http://118.190.17.80:8000/api/mobilepay/order/status/%s/%s'
# get_account_tuniu = 'http://localhost:8000/api/mobilepay/account/tuniu'
get_account_tuniu = 'http://118.190.17.80:8000/api/mobilepay/account/tuniu'
put_account = 'http://118.190.17.80:8000/api/mobilepay/account/%d'
put_account_ordercount = 'http://118.190.17.80:8000/api/mobilepay/account/ordercount/%s'
put_aacount_cantuse = 'http://118.190.17.80:8000/api/mobilepay/account/cantuse/%d'
