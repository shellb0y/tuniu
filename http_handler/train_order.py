...
def get_train_list(data):
    headers = {'User-Agent': 'TuNiuApp/9.0.1/Dalvik/1.6.0 (Linux; U; Android 4.2.2)',
               'Content-Type': 'application/json; charset=UTF-8'}

    url = 'http://m.tuniu.com/api/train/product/ticketListWithFresh?c=%7B%22v%22%3A%229.0.1%22%2C%22ct%22%3A20%2C%22dt%22%3A1%2C%22ov%22%3A1%2C%22p%22%3A15447%2C%22cc%22%3A1502%7D'
